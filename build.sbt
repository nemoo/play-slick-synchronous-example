...
libraryDependencies += "com.dimafeng" %% "testcontainers-scala-scalatest" % "0.40.4" % "test"
libraryDependencies += "com.dimafeng" %% "testcontainers-scala-postgresql" % "0.40.4" % "test"
