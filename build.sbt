...
libraryDependencies += "com.dimafeng" %% "testcontainers-scala-scalatest" % "0.40.9" % "test"
libraryDependencies += "com.dimafeng" %% "testcontainers-scala-postgresql" % "0.40.9" % "test"
